...
const Testimonials = () => {
  return (
    <section className="text-gray-600 py-12 dark:bg-gray-900 dark:text-white transition-colors">
      <div className="container px-5 py-24 mx-auto">
        <h2 className="text-3xl font-medium  text-gray-900 dark:text-slate-200 mb-12 text-center">
          Testimonials
        </h2>
        <Swiper
          slidesPerView={1}
