...
const FeaturedBlogs = () => {
  return (
    <section className="py-12 dark:bg-gray-900 dark:text-white transition-colors">
        ...
        <div className="-mx-4 flex flex-wrap">
          <div className="w-full px-4 md:w-1/2 lg:w-1/3">
            <div className="mx-auto mb-10 max-w-[370px]">
              ...
              <div>
                <span className="bg-cyan-300 mb-5 inline-block rounded py-1 px-4 text-center text-xs font-semibold leading-loose text-dark dark:text-white">
                  Dec 22, 2023
                </span>
                <h3>
                  <a
